...
public class MergerPoolList {
    ...
    // Constructor
    public MergerPoolList(int serviceId,int hostId, int poolId, String poolName, int currentMembers, int membersAllowed, String poolType, String poolState, boolean isPrivate) {
        this.hostId = hostId;
        this.poolId = poolId;
    ...
    // Setters
    public void setPlanId(int planId) { this.hostId = planId; }
